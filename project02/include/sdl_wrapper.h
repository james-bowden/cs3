...
/**
 * Draws a polygon from the given a polygon object.
 *
 * @param polygon_t polygon object with the points and RGB color float values
 */
void sdl_draw_polygon(polygon_t *polygon);
