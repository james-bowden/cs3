...
const double WIN_DIM_X = 100.0;
const double WIN_DIM_Y = 75.0;
...
const vector_t PLAYER_DIM = (vector_t){20, 3};
const double RADIUS_BALL = 3;
...
const vector_t BALL_VEL = (vector_t){200, 200};
